...
public class BigramFrequencyStripes extends Configured implements Tool {
	...
	private static class MyReducer extends
		...
		public void reduce(Text key,
			...
			float total = 0;	// total count of this first word(key) / First pass to get the total count
			...
			BIGRAM.set(first_w, "");
			MARGINAL.set(total);
			context.write(BIGRAM, MARGINAL);

	        for (Entry<String, Integer> mapElement : SUM_STRIPES.entrySet()) { 	// Second pass to get the frequency, for each second word
